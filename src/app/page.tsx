        ...
        setDynamicContent(
          <>
            <div className="pl-3 pr-3 flex flex-col items-start">
              ...
              <br />
              <li><Link href="https://nextjs.org" inline target="_blank">Next.js</Link> 作为脚手架</li>
              <li><Link href="https://react.fluentui.dev" inline target="_blank">Fluent UI React v9</Link> 作为 UI 组件库</li>
              <li><Link href="https://github.com/FloatSheep/cacheManager" inline target="_blank">cacheManager</Link> 作为持久化储存管理器</li>
              <br />
              <p className="text-center text-xs text-gray-500 justify-center flex">Made by FloatSheep with ❤</p>
            </div>
          </>
        );
      }
  ...
  return (
    <>
      ...
      <div className="w-[100%] grid fixed translate-y-[-50%] top-[50%] will-change-transform">
        <Card className={styles.card}>{dynamicContent}</Card>
      </div>
    </>
  );
}
